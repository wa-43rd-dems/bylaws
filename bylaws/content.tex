\begin{abstract}
    The purpose of the \fortythird{} District \edit{Democratic Organization}{Democrats} is to promote the Democratic Party and to increase participation by educating individuals about the principles, goals and candidates of the Democratic Party.
\end{abstract}

\section{Name}
\subsection{}
This organization shall be known as the \fortythird{} District \edit{Democratic Organization}{Democrats}.
...
\begin{inlinealphalist}
    ...
    \item has paid applicable dues but is either not a registered voter or does not reside within the \fortythird{} Legislative District. Non-voting Members may participate in Meetings and other \fortythird{} District \add{Democrats} events but do not have the right to vote on any matter.
\end{inlinealphalist}
...
\begin{alphalist}
    ...
    \item The date when the \fortythird{} \edit{LD}{District} Democrats recommend his or her appointment as an Acting PCO or
Appointed PCO;
...
\subsection{}
Members shall not use any title of office or identify themselves as representing the \fortythird{} District \add{Democrats} unless authorized by the Membership or the Executive Board.
...
``Regular Meeting" means a regularly scheduled meeting of the \fortythird{} District \add{Democrats}. The time and date for a Regular Meeting may be altered by the Membership or the Executive Board. Notice of any change in the time or date of a Regular Meeting must be published at least thirty (30) days before the new meeting date.
...
``Reorganization Meeting" means a meeting called by the County Chair for the purpose of reorganizing the \fortythird{} District \add{Democrats}
\begin{inlinealphalist}
...
The Executive Board of the \fortythird{} District \add{Democrats} shall consist of the Chair, First Vice Chair, Treasurer, Vice Chair for Elections, Vice Chair for PCO Recruitment, Vice Chair for Membership, Vice Chair for Communications, Vice Chair for Technology, Vice Chair for Events, Vice Chair for Programs and Meetings, Secretary, State Committeewoman, State Committeeman, Female KCDCC Delegate, Male KCDCC Delegate, Female KCDCC Alternate, Male KCDCC Alternate, and Young Democrats Representative.
...
\subsection{}
The Executive Board shall establish a regular monthly meeting for the purpose of planning and directing the policies and activities of the \fortythird{} \edit{LD}{District} Democrats. Special meetings of the Executive Board may be called by a majority of its members.

\section{Duties of Officers}
\subsection{}
The Chair shall
\begin{inlinealphalist}
    \item act as the chief executive officer of the \fortythird{} District \add{Democrats};
    ...
    \item report to the Executive Board and the membership regarding activities of the \fortythird{} \edit{LD}{District} Democrats;
    \item implement the policies of the \fortythird{} District \add{Democrats} and the Executive Board;
    ...
    \item provide oversight and review of the \edit{district}{\fortythird{} District Democrats'} treasury and related financial documents, and
...
\begin{inlinealphalist}
    ...
    \item in the absence of the Chair, represent the \fortythird{} \edit{LD}{District} Democrats at party organization, for example; the KCDCC executive board;
...
The Treasurer shall
\begin{inlinealphalist}
    \item maintain a bank or credit union account for the \fortythird{} District \add{Democrats};
    \item receive and disburse the funds of the \fortythird{} District \add{Democrats};
    \item maintain the financial records of the \fortythird{} District \add{Democrats};
...
The Secretary shall
\begin{inlinealphalist}
    \item keep the minutes of all meetings and all records of the \fortythird{} District \add{Democrats} except those assigned to other Officers;
...
There shall be at least six (6) standing committees of the \fortythird{} \edit{LD}{District} Democrats:
\begin{inlinealphalist}
...
\begin{inlinealphalist}
    ...
    \item organize and manage other non-meeting events of the \fortythird{} District \add{Democrats}; and
...
\begin{inlinealphalist}
    ...
    \item coordinate functions of regular and special meetings of the \edit{district}{\fortythird{} District Democrats}, such as sign-in and set-up;
    \item monitor issues of interest to the \fortythird{} District \add{Democrats}; and
...
\subsection{}
Upon petition for removal signed by at least one-third (1/3) of the Elected PCOs, the \fortythird{} District \add{Democrats} shall consider the removal of the Chair. The Chair may be removed by a two-thirds (2/3) majority of the Elected PCOs present and voting at the Meeting, not counting abstentions.

\subsection{}
Upon petition for removal signed by at least one-third (1/3) of the Elected PCOs and Appointed PCOs, the \fortythird{} District \add{Democrats} shall consider the removal of the Treasurer, State Committeewoman, State Committeewoman, Female KCDCC Delegate, or Male KCDCC Delegate, Female KCDCC Alternate Delegate, and Male KCDCC Alternate Delegate. Any of these Officers may be removed two-thirds (2/3) of the Elected and Appointed PCOs present and voting at the Meeting, not counting abstentions.

\subsection{} \label{eb-removal}
Upon petition for removal signed by one-fourth (1/4) of the Members or a majority of the Executive Board, the \fortythird{} District \add{Democrats} shall consider the removal of Vice Chair for Elections, Vice Chair for Recruitment, Vice Chair for Communications, Vice Chair for Technology, the Vice Chair for Events, Vice Chair for Programs, Secretary, Young Democrat Representative, LAC Representative, and Special Advisor to the Executive Board. Any of these Officers or members of the Executive Board may be removed by a two-thirds (2/3) majority of the Members present and voting at the Meeting, not counting abstentions.
...
\subsection{}
Except for as provided in these bylaws, the \fortythird{} District \add{Democrats} shall not consider resolutions that
\begin{inlinealphalist}
...
\section{Censure}
\subsection{}
Members may move that the \fortythird{} District \add{Democrats} censure a Member; an officer or official of the national party, state party, KCDCC, or \fortythird{} District \add{Democrats}; an elected official or candidate that the \fortythird{} District \add{Democrats} has previously endorsed; or any other individual. A censure is an official public statement by the \fortythird{} District \add{Democrats} condemning, reprimanding, or disapproving of specific conduct of an individual.
...
\subsection{}
The \fortythird{} District \add{Democrats} may endorse candidates for elected office and take positions on ballot measures.  Endorsements may be revoked using the same procedures used for making endorsements.
...
\subsection{}
The Executive Board may make reports and recommendations to the Membership regarding endorsements, including note of a candidate’s contributions to the \fortythird{} District \add{Democrats}.
...
\subsection{}
Endorsements must be approved by at least sixty percent (60\%) of the Members present and voting at the Meeting, not counting abstentions. More than one (1) candidate for the same office may be endorsed. In the event that more than one candidate is endorsed, the \fortythird{} District \add{Democrats} may not make any monetary campaign contributions to any of the candidates for that office.

\subsection{}
The \fortythird{} District \add{Democrats} may not endorse any candidate prior to the start of candidate filing or a ballot measure prior to filing approved ballot language unless
\begin{inlinealphalist}
...
\subsection{}
Prior to passage of the budget, the Executive Board may authorize reasonable expenditures as necessary to maintain the \edit{district}{\fortythird{} District Democrats}.
...
\subsection{}
In the event of a nominating convention, the \fortythird{} District \add{Democrats} shall comply with the bylaws of the Democratic Party of the State of Washington.

\subsection{}
The rules contained in the current edition of Robert’s Rules of Order Newly Revised shall govern the \fortythird{} \edit{LD}{District} Democrats in all cases to which they are applicable and in which they are not inconsistent with these bylaws and any special rules of order the \fortythird{} District \add{Democrats} may adopt.

\subsection{}
The records and membership list of the \fortythird{} District \add{Democrats} shall be made available as provided in the \fortythird{} District\edit{'s}{Democrats'} endorsement procedures or as required by law. The records and membership list shall not be used for any other purpose, unless approved by a majority of the Executive Board, with notice to the membership.
...
\begin{alphalist}
    ...
    \item ``Chair" means the Chair of the \fortythird{} District \edit{Democratic Organization}{Democrats}.
    ...
    \item ``Membership" means the Members assembled at a Meeting of the \fortythird{} District \add{Democrats}.
